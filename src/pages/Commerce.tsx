  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-12 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Stripe Payment Integration</h2>
        <p className="text-gray-600 mb-6">Configure Stripe in Settings to start accepting payments</p>
