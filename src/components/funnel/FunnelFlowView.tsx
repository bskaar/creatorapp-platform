...
import { Plus, CreditCard as Edit, Trash2, Eye, MoreVertical, GripVertical, ArrowRight, Copy, BarChart3, ExternalLink, ZoomIn, ZoomOut } from 'lucide-react';
...
export function FunnelFlowView({
  ...
  const getPageTypeColor = (type: string) => {
    const colors: Record<string, { bg: string; border: string; text: string }> = {
      ...
      optin: { bg: 'bg-purple-50', border: 'border-purple-200', text: 'text-purple-700' },
            ...
            return (
              <div key={page.id} className="flex items-center">
                <div
                  ...
                  className={`relative group w-64 bg-white rounded-xl border-2 shadow-sm hover:shadow-md transition-all cursor-move ${
